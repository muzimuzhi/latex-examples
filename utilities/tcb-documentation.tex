...
% list of no-duplication label names
\clist_new:N \l_tcb_doc_labelnames_clist
% list of no-duplication cmd names 
\clist_new:N \l_tcb_doc_cmdnames_clist
% seq of "{{name}{para}{dect}}"
...
\cs_new:Nn \tcb_doc_head_parse_kv:n
  {
    ...
    % store item of \l_tcb_doc_heads_clist in \l_tcb_temp_seq
