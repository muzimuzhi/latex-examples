\pgfkeys{
  ...
  /utils/ifnum TF/.style n args={5}{
    /utils/@ifxxx TF={\ifnum\numexpr#1\relax#2\numexpr#3\relax}{#4}{#5}
  },
  /utils/ifx TF/.style n args={4}{
    /utils/@ifxxx TF={\ifx#1#2}{#3}{#4}
  }
}
