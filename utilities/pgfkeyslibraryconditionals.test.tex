...
\BeginUnitTests{/utils/if TF}
  % undefined
  \pgfkeys{/utils/if TF={abc}{t}{f}} \AssertFalseResult
  % primitive
  \pgfkeys{/utils/if TF={mmode}{t}{f}} \AssertFalseResult
  % user-defined
  \csname @tempswafalse\endcsname
  \pgfkeys{/utils/if TF={@tempswa}{t}{f}} \AssertFalseResult
  \csname @tempswatrue\endcsname
  \pgfkeys{/utils/if TF={@tempswa}{t}{f}} \AssertTrueResult
\EndUnitTests

\BeginUnitTests{/utils/ifnum TF}
  \pgfkeys{/utils/.cd,
    ifnum TF={3}{=}{1+2}tf, exec=\AssertTrueResult,
    ifnum TF={2*5}>{7/3}tf, exec=\AssertTrueResult
  }
\EndUnitTests

\BeginUnitTests{/utils/ifx TF}
  \pgfkeys{/utils/.cd,
    ifx TF={a}{a}tf, exec=\AssertTrueResult,
    ifx TF={a}{b}tf, exec=\AssertFalseResult,
    ifx TF/.expanded={\relax}{\expandafter\noexpand\csname\endcsname}tf,
    exec=\AssertTrueResult,
    ifx TF=\undefined\label tf, exec=\AssertFalseResult
  }
\EndUnitTests
