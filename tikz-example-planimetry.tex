...
\tikzset{
  dot/.style={circle, fill=black, inner sep=1pt, outer sep=0pt},
  every label/.append style={circle, inner sep=0pt, outer sep=1pt},
  % every pics named "right angle"
  pics/right angle/.append style={/tikz/draw, /tikz/angle radius=5pt}
}
\begin{document}
