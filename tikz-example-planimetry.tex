...
\tikzset{
  ...
  dot label/.style={circle, inner sep=0pt, outer sep=1pt},
  right angle/.style={draw, angle radius=5pt}
}
\begin{document}
...
\begin{tikzpicture}
  ...
  \draw[line width=.5pt] 
    ...
    (N) -- (L);
  % draw right angles
  \draw pic[right angle] {right angle=P--K--Q}
        pic[right angle] {right angle=N--L--Q};
  % mark points
